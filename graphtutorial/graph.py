...
def make_graph_call():
    ...
    # one_drive_utils.list_drive_items(this.user_client)
    # one_drive_utils.create_folder_in_onedrive(this.user_client)
    # document_id = one_drive_utils.fetch_documents_id(this.user_client)
    one_drive_utils.upload_file_on_one_drive(this.user_client)
    return
# </MakeGraphCallSnippet>
